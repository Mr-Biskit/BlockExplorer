export default function Header() {
  return (
    <div className="fixed w-full flex items-center  h-14 text-primary z-10">
      <div className="flex items-center justify-start md:justify-center pl-3  md:w-64 h-14 bg-blue-800 dark:bg-gray-800 border-none w-1/3">
        <img
      ...
      <div className="flex justify-evenly items-center h-14 bg-blue-800 dark:bg-gray-800 w-2/3">
